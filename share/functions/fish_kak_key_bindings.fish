function fish_vi_key_bindings --description 'vi-like key bindings for fish'
    ...
    if test "$fish_key_bindings" != fish_kak_key_bindings
        ...
        # are executed.
        set fish_key_bindings fish_kak_key_bindings
        return
    end
    ...
    set -l eol_keys gl \el
    set -l bol_keys gh \eh
    ...
    # See #2871
    bind -s --preset -M insert \e "if commandline -P; commandline -f cancel; else; commandline -f begin-selection; set fish_bind_mode visual; commandline -f backward-char repaint-mode; end"
    ...
    bind -s --preset -M visual b begin-selection backward-word
    bind -s --preset -M visual B backward-word
    bind -s --preset -M visual \eb begin-selection backward-bigword
    bind -s --preset -M visual \eB backward-bigword
